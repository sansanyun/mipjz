...
class Articles extends Controller
{
    ...
    public function getItemListbyTagIds($cid = null, $page = 1, $limit = 10, $orderBy = 'publish_time', $order = 'desc', $where = null,$keywords = null, $whereArray = null,$tagName = null,$tagIds = null, $itemType = null)
    {
        if ($tagNames) {
    ...
    public function getPaginationbyTagIds($cid = null, $page = 1, $perPage = 10, $orderBy = 'publish_time', $order = 'desc', $where = null,$keywords = null,$whereArray = null,$tagName = null,$tagIds = null,$itemType = null)
    {
        if ($tagNames) {
            $tagNames = explode(',',$tagNames);
            foreach ($tagNames as $val) {
