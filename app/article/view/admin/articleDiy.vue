    ...
    methods: {
        ...
        delItem: function(index,item) {
            this.$Modal.confirm({
                ...
                onOk: () => {
                    this.$mip.ajax('{$domain}/article/ApiAdminArticleDiy/delItem', {
        ...
        addItem: function() {
            ...
            this.$mip.ajax('{$domain}/article/ApiAdminArticleDiy/addField', {
        ...
        editItem: function() {
            ...
            this.$mip.ajax('{$domain}/article/ApiAdminArticleDiy/editField', {
                fieldTitle: this.field.fieldTitle,
                fieldName:  this.field.fieldName,
