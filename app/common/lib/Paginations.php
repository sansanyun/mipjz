...
//        $this->cur_page = floor(($this->cur_page / $this->per_page) + 1);
...

        {
...

            {
                ...
                $output .= $this->prev_tag_open.'<a class="page-link" data-type="mip" '.$this->anchor_class.'href="'.$this->page_base_url.$i.'">'.$this->prev_link . '</a>'.$this->prev_tag_close;
...

            {
...

                {
...

                    {
                        ...
                        $output .= $this->num_tag_open.'<a class="page-link" data-type="mip" '.$this->anchor_class.'href="'.$this->page_base_url.$n.'">'.$loop.'</a>'.$this->num_tag_close;
...

        {
            ...
            $output .= $this->next_tag_open.'<a class="page-link" data-type="mip" '.$this->anchor_class.'href="'.$this->page_base_url.$this->prefix.($this->cur_page + 1).$this->suffix.'">'.$this->next_link.'</a>'.$this->next_tag_close;
...

        {
            ...
            $output .= $this->last_tag_open.'<a class="page-link" data-type="mip" '.$this->anchor_class.'href="'.$this->page_base_url.$this->prefix.$i.$this->suffix.'">'.$this->last_link.'</a>'.$this->last_tag_close;
